...
O Projeto é do curso Python AI Backend Developer da DIO para colocar em prática as atividades vistas até o momento.
Agora avançamos um pouco e colocamos a estrutura em funções.
